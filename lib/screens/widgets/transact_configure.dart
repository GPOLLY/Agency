...
class Transact{
  ...
  Transact({this.accountNumber, this.product, this.amount,this.password,this.date,this.reference, this.username});
...
class TransactConfigure{
  ...
  static Future<String> addTransact(String accountNumber, String amount, String product, String date, String reference, String username, String description) async {
    try {
      var map = Map<String, dynamic>();
      map['action'] = _ADD_TRANSACT_ACTION;
      map['acnumber'] = accountNumber;
      map['amount'] = amount;
      map['product'] = product;
      map['date_t'] = date;
